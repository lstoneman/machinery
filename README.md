...
[![godoc for RichardKnop/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/lstoneman/machinery/v1)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/lstoneman/machinery)](https://goreportcard.com/report/github.com/lstoneman/machinery)
[![GolangCI](https://golangci.com/badges/github.com/lstoneman/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for RichardKnop/machinery](https://sourcegraph.com/github.com/lstoneman/machinery/-/badge.svg)](https://sourcegraph.com/github.com/lstoneman/machinery?badge)
...
import (
  ...
  locksiface "github.com/lstoneman/machinery/v2/locks/iface"
)
...
```sh
go get github.com/lstoneman/machinery/v2
```

If you want to use legacy v1 version, you still can:

```sh
go get github.com/lstoneman/machinery
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/lstoneman/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/lstoneman/machinery/v1/log` package:
...
```go
import (
  "github.com/lstoneman/machinery/v1/config"
  "github.com/lstoneman/machinery/v1"
)
...
```go
import (
  "github.com/lstoneman/machinery/v1/tasks"
)
